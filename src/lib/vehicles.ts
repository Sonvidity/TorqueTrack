...
export const vehicles: Vehicle[] = [
  {
    ...
    models: [
        ...
        { name: "Mondeo (Mk2)", years: Array.from({ length: 2007 - 2000 + 1 }, (_, i) => 2000 + i), engine: "Duratec V6 / Duratorq" },
        { name: "Mondeo (Mk3)", years: Array.from({ length: 2014 - 2007 + 1 }, (_, i) => 2007 + i), engine: "EcoBoost / Duratorq" },
        { name: "Mondeo (Mk4)", years: Array.from({ length: 2022 - 2014 + 1 }, (_, i) => 2014 + i), engine: "EcoBoost / Duratorq" },
  ...
  },
  {
    make: "Isuzu",
    models: [
        { name: "D-MAX", years: Array.from({ length: 2012 - 2008 + 1 }, (_, i) => 2008 + i), engine: "4JJ1" },
    ],
  },
  {
    make: "Mazda",
    models: [
      ...
      { name: "Mazda6 (GG/GY)", years: Array.from({ length: 2008 - 2002 + 1}, (_, i) => 2002 + i), engine: "MZR / L3-VDT (MPS)" },
      { name: "Mazda6 (GH)", years: Array.from({ length: 2012 - 2007 + 1}, (_, i) => 2007 + i), engine: "MZR" },
      { name: "Mazda6 (GJ/GL)", years: Array.from({ length: 2025 - 2012 + 1}, (_, i) => 2012 + i), engine: "Skyactiv-G" },
